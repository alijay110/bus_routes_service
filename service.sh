...
# Example passing correct argument for bus provider file path:
# ./service.sh dev_run --file.path=data/example
dev_run() {
  # "$@" passes parameter from function to command below:
  java -jar target/bus_routes_service-0.0.1.jar "$@"
  sleep 600
}
